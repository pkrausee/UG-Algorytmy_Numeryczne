...
//    @org.junit.Test
    public void TestMatrixForDoubleType() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileOutputStream("H2_Double_MatrixV2.csv"))) {
...
//    @org.junit.Test
    public void TestMatrixForFloatType() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileOutputStream("H2_Float_MatrixV2.csv"))) {
            for (int i = jump; i <= numberOfTests; i += jump) {
    ...
    public void TestMatrixForFractionType() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileOutputStream("H2_Fraction_MatrixV2.csv"))) {
            for (int i = jump; i <= numberOfTests; i += jump) {
                ...
                Fraction XpNP_Er = MatrixUtilities.avg(adapter, XpNP_ErrorArr);
                Fraction XpPP_Er = MatrixUtilities.avg(adapter, XpPP_ErrorArr);
                Fraction XpFP_Er = MatrixUtilities.avg(adapter, XpFP_ErrorArr);
